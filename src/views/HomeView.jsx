                        ...
                        <Col lg={6} xl={3} mb={2}>
                            <Card className="sectionBorder">
                                ...
                                <Card.Body className="d-flex justify-content-around align-items-center">
                                    ...
                                    <div className="dash-tile-text text-black-50"><h1 id="txtCustomerCount">00</h1></div>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col lg={6} xl={3} mb={2}>
                            <Card className="sectionBorder">
                                ...
                                <Card.Body className="d-flex justify-content-around align-items-center">
                                    ...
                                    <div className="dash-tile-text text-black-50"><h1 id="txtItemsCount">00</h1></div>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col lg={6} xl={3} mb={2}>
                            <Card className="sectionBorder">
                                ...
                                <Card.Body className="d-flex justify-content-around align-items-center">
                                    ...
                                    <div className="dash-tile-text text-black-50"><h1 id="txtOrderCount">00</h1></div>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col lg={6} xl={3} mb={2}>
